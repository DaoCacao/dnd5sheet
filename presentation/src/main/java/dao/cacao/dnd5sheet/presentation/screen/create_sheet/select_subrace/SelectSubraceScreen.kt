...
fun SelectSubraceScreen(
    state: SelectSubrace.State,
    onNavigateUp: (() -> Unit)? = null,
    onRaceClick: (Subrace) -> Unit = {},
    onRaceInfoClick: (Subrace) -> Unit = {},
) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = stringResource(id = R.string.text_create_character),
                subtitle = stringResource(R.string.text_select_subrace),
