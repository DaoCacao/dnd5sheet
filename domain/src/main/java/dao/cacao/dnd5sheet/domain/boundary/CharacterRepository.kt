...
interface CharacterRepository {
    ...
    suspend fun updateCharacterClass(characterId: Long, characterClass: String): Flow<Character>
    suspend fun updateCharacterRace(characterId: Long, characterRace: String): Flow<Character>
